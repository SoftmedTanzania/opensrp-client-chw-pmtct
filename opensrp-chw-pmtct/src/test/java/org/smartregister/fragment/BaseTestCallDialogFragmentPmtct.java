...
@PrepareForTest(BasePmtctCallDialogFragment.class)
public class BaseTestCallDialogFragmentPmtct {
    @Spy
    public BasePmtctCallDialogFragment basePmtctCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BasePmtctCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Whitebox.invokeMethod(basePmtctCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
    ...
    public void initUI() throws Exception {
        ...
        Whitebox.invokeMethod(basePmtctCallDialogFragment, "initUI", viewGroup);
        PowerMockito.verifyPrivate(basePmtctCallDialogFragment).invoke("setCallTitle", viewGroup, view.getId(), "message");
