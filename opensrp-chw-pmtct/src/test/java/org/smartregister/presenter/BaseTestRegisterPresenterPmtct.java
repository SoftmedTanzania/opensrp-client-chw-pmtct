...
@PrepareForTest(BasePmtctRegisterPresenter.class)
public class BaseTestRegisterPresenterPmtct {
    @Mock
    protected BasePmtctRegisterPresenter basePmtctRegisterPresenter;

    @Mock
    protected PmtctRegisterContract.Interactor interactor;
    @Mock
    protected PmtctRegisterContract.Model model;
    @Mock
    protected PmtctRegisterContract.View baseView;
    private BasePmtctRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BasePmtctRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(basePmtctRegisterPresenter, "getView"));
    }
