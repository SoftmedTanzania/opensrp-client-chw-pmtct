...
public class PmtctRegisterProvider implements RecyclerViewProvider<PmtctRegisterProvider.RegisterViewHolder> {
    ...
    protected void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BasePmtctRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setOnClickListener(onClickListener);
            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BasePmtctRegisterFragment.FOLLOW_UP_VISIT);
