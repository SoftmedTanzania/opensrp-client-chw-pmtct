...
public class BasePmtctRegisterActivity extends BaseRegisterActivity implements PmtctRegisterContract.View {
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BasePmtctRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BasePmtctRegisterActivity.class);
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new PmtctBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BasePmtctRegisterPresenter(this, new BasePmtctRegisterModel(), new BasePmtctRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BasePmtctRegisterFragment();
    }
    ...
    @Override
    public PmtctRegisterContract.Presenter presenter() {
        return (PmtctRegisterContract.Presenter) presenter;
    }
...
//                process malaria form
    ...
    public void startClientProcessing() {
        try {
            ...
            PmtctUtil.getClientProcessorForJava().processClient(PmtctUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
