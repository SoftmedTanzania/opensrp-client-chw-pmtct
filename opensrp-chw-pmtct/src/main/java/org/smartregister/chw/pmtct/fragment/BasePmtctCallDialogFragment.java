...
import org.smartregister.chw.pmtct.listener.BasePmtctCallWidgetDialogListener;
import org.smartregister.pmtct.R;

import static android.view.View.GONE;
import static org.smartregister.util.Utils.getName;

public class BasePmtctCallDialogFragment extends DialogFragment implements BasePmtctCallDialogContract.View {
    ...
    public static BasePmtctCallDialogFragment launchDialog(Activity activity, MemberObject MO) {
        BasePmtctCallDialogFragment dialogFragment = BasePmtctCallDialogFragment.newInstance();
    ...
    public static BasePmtctCallDialogFragment newInstance() {
        return new BasePmtctCallDialogFragment();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        setUpPosition();
        if (listener == null) {
            listener = new BasePmtctCallWidgetDialogListener(this);
        }
    ...
    @Override
    public void setPendingCallRequest(BasePmtctCallDialogContract.Dialer dialer) {
