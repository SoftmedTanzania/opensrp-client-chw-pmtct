...
public class VisitUtils {
    ...
    public static List<Visit> getVisits(String memberID, String... eventTypes) {
        ...
        List<Visit> visits = (eventTypes != null && eventTypes.length > 0) ? getVisitsOnly(memberID, eventTypes[0]) : getVisitsOnly(memberID, Constants.EVENT_TYPE.PMTCT_FOLLOWUP);
    ...
    public static List<Visit> getVisitsOnly(String memberID, String visitName) {
        return new ArrayList<>(PmtctLibrary.getInstance().visitRepository().getVisits(memberID, visitName));
    }
    ...
    public static void processVisits(String baseEntityID) throws Exception {
        processVisits(PmtctLibrary.getInstance().visitRepository(), PmtctLibrary.getInstance().visitDetailsRepository(), baseEntityID);
    }
