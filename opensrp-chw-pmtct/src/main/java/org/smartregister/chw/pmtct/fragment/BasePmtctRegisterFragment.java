...
public class BasePmtctRegisterFragment extends BaseRegisterFragment implements PmtctRegisterFragmentContract.View {
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.pmtct));
    ...
    public PmtctRegisterFragmentContract.Presenter presenter() {
        return (PmtctRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BasePmtctRegisterFragmentPresenter(this, new BasePmtctRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BasePmtctProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
